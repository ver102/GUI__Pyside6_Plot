...
################################################################################
## Form generated from reading UI file 'testtGnpCA.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.verticalLayoutWidget.setGeometry(QRect(60, 180, 661, 401))
        self.verticalLayout_3 = QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.comBox = QComboBox(Dialog)
        self.comBox.setObjectName(u"comBox")
        self.comBox.setGeometry(QRect(60, 30, 120, 30))
        font1 = QFont()
        ...
        self.comBox_2.setGeometry(QRect(200, 30, 120, 30))
        self.comBox_2.setFont(font1)
        self.label_11 = QLabel(Dialog)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(350, 20, 80, 30))
        self.label_11.setFont(font)
        self.label_11.setAlignment(Qt.AlignCenter)
        self.label_5 = QLabel(Dialog)
        self.label_5.setObjectName(u"label_5")
        self.label_5.setGeometry(QRect(350, 60, 80, 30))
        self.label_5.setFont(font)
        self.label_5.setAlignment(Qt.AlignCenter)
        self.input_path = QLineEdit(Dialog)
        self.input_path.setObjectName(u"input_path")
        self.input_path.setGeometry(QRect(440, 20, 280, 30))
        font2 = QFont()
        ...
        self.save_find.setGeometry(QRect(720, 60, 50, 30))
        self.save_find.setAutoFillBackground(False)
        self.save_find.setFlat(False)
        self.label_3 = QLabel(Dialog)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 620, 50, 30))
        self.label = QLabel(Dialog)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(70, 620, 140, 30))
        ...
        self.label_2.setGeometry(QRect(210, 620, 120, 30))
        self.label_2.setStyleSheet(u"")
        self.label_2.setFrameShape(QFrame.NoFrame)
        self.label_2.setFrameShadow(QFrame.Plain)
        self.label_2.setAlignment(Qt.AlignCenter)
        self.json_path = QLineEdit(Dialog)
        self.json_path.setObjectName(u"json_path")
        self.json_path.setGeometry(QRect(440, 100, 280, 30))
        self.json_path.setFont(font2)
        self.label_6 = QLabel(Dialog)
        self.label_6.setObjectName(u"label_6")
        self.label_6.setGeometry(QRect(380, 100, 60, 30))
        self.label_6.setFont(font)
        self.label_6.setAlignment(Qt.AlignCenter)
        self.json_find = QPushButton(Dialog)
        self.json_find.setObjectName(u"json_find")
        self.json_find.setGeometry(QRect(720, 100, 50, 30))
        self.json_find.setAutoFillBackground(False)
        self.json_find.setFlat(False)
        self.Exe = QPushButton(Dialog)
        self.Exe.setObjectName(u"Exe")
        self.Exe.setGeometry(QRect(60, 110, 80, 30))
        ...
        self.Stop.setGeometry(QRect(150, 110, 80, 30))
        ...
        self.json_find.setDefault(True)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.json_path.setText(QCoreApplication.translate("Dialog", u"\ud3f4\ub354\ub97c \uc120\ud0dd\ud574\uc8fc\uc138\uc694", None))
        self.label_6.setText(QCoreApplication.translate("Dialog", u"Config", None))
        self.json_find.setText(QCoreApplication.translate("Dialog", u"Open", None))
